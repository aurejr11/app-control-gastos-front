    ...
    <div class="relative flex min-h-screen w-full flex-col overflow-x-hidden bg-slate-50 dark:bg-slate-950">
        ...
        <div class="mx-auto w-full max-w-3xl px-4 py-4 flex items-center justify-between gap-4">
          <div class="flex items-center gap-3">
            ...
            <div class="flex flex-col leading-tight">
              <span class="text-slate-900 dark:text-slate-100 text-sm font-semibold">Crear gasto</span>
              <span class="text-slate-600 dark:text-slate-400 text-xs">Registro de un nuevo expense</span>
            </div>
          </div>
      ...
      <main class="mx-auto w-full max-w-3xl px-4 py-8 flex flex-col gap-6">
        <section class="flex flex-col gap-2">
          <h1 class="text-slate-900 dark:text-slate-100 text-2xl font-bold tracking-tight">Registrar Expense</h1>
          <p class="text-slate-600 dark:text-slate-400 text-sm">
            Completa los campos del modelo (sin el id). La imagen se registra como texto.
          </p>
        </section>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div class="sm:col-span-2 flex flex-col gap-2">
                ...
                <input
                  ...
                  placeholder="Ej: Reserva AWS EC2 - Proyecto Final"
                  type="text"
                />
              </div>
              ...
              <div class="sm:col-span-2 flex flex-col gap-2">
                ...
                <input
                  ...
                  type="text"
                />
                <p class="text-xs text-slate-500 dark:text-slate-400">Puedes guardar el nombre de un ícono o recurso.</p>
              </div>
